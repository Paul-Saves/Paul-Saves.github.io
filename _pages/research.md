...
<div class="card border-primary bg-light shadow-sm mb-4" style="border-left: 5px solid;">
    ...
    <section id="funding" class="mb-5">
      <h2 class="h5 font-weight-bold mb-4 text-primary text-uppercase"><i class="fas fa-hand-holding-usd mr-2"></i> Grants & Funding</h2>
    ...
    <section id="supervision" class="mb-5">
	  ...
	  <li class="mb-2"><i class="fas fa-user-graduate text-muted mr-2"></i> <strong>Restu Ananda Putra</strong> (2026-Present), Ph.D. in Statistics, LPDP Ministry of Research, Indonesia, "Spatio-Temporal Agent-based Surrogates Simulation of Urban Resilience in Indonesia".<em>Official Supervisor</em>.</li>
        ...
        <ul class="list-unstyled small mb-4 text-secondary">
          ...
          <li class="mb-2"><i class="fas fa-hands-helping text-primary mr-2"></i> <strong>Clément Blanco-Volle</strong>, Ph.D. in Computer Science. Support in formal aspects of online learning from agent-based systems.</li>
        </ul>
    ...
    <section id="service" class="mb-5">
      <h2 class="h5 font-weight-bold mb-4 text-primary text-uppercase"><i class="fas fa-bullseye mr-2"></i> Professional Service</h2>
      <div class="row small">
        <div class="col-md-6 mb-4">
        ...
        <div class="col-md-6 mb-4">
          ...
          <div class="d-flex flex-wrap small">
            <span class="badge badge-light border mr-1 mb-1 shadow-sm">Nature Scientific Reports (5)</span>
